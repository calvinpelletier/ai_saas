# from https://github.com/chenxi116/DeepLabv3.pytorch
import torch
...
def build_resnet101(pretrained=False, num_groups=None, weight_std=False, **kwargs):
    ...
    if pretrained:
        ...
        if num_groups and weight_std:
            pretrained_dict = torch.load(download_model('deeplab/R-101-GN-WS.pth.tar'))
